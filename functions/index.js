// NOTE: This file uses 1st Gen Firebase Functions syntax.
...
const WHITELISTED_COLLECTIONS = new Set([
  ...
  "HEyazxpV2wxMUvNx53UZUXthRS9Rjsbv7hoHYJNbVedC", "DoJoE6b8Lbb1t8qcdm4qDRXLS7RvadZo9Rfz8xq2VgLx"
]);
const SPIN_COST = 10;
...
const checkNftCountOnChain = async (ownerAddress) => {
    ...
    try {
        const response = await fetch(HELIUS_API_URL, {
            ...
            body: JSON.stringify({ jsonrpc: '2.0', id: 'digital-dojo-check', method: 'getAssetsByOwner', params: { ownerAddress, page: 1, limit: 1000 } }),
        });
        ...
        for (const asset of assets) {
            ...
            if (!collectionAddress && asset.content?.links?.collection) {
  ...
  return db.runTransaction(async (transaction) => {
    ...
    if (!userDoc.exists) {
        ...
        transaction.set(userDocRef, {
            walletAddress: uid, nftCount, tetoBalance: 0,
            lastClaimTimestamp: admin.firestore.Timestamp.fromDate(startOfPreviousHour),
        });
